...
define("EW_PROJECT_NAME", "cssociety", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{B9BF3307-7A7A-4ACA-81A3-DC180D98192D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'h1pgTb9NKV1Wgeqj', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/cssociety.css", TRUE); // Project stylesheet file name
...
// define("EW_CONN_DB", 'cslatam', TRUE);
...
// User table filters
define("EW_USER_TABLE", "`owners`",  TRUE);
define("EW_USER_NAME_FILTER", "(`Correo Electronico` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "",  TRUE);
define("EW_USER_EMAIL_FILTER", "(`Correo Electronico` = '%e')",  TRUE);
...
define("EW_UPLOAD_DEST_PATH", conf_cdn_path.conf_domain.'/', TRUE); //jamesjara Upload destination path (relative to app root)
