...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("blogslist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("fb_gruposlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("feedbacklist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("noticiaslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("paiseslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("ownerslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("audittraillist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("fb_postslist.php");
		if ($Security->IsLoggedIn()) {
			$this->setFailureMessage($Language->Phrase("NoPermission") . "<br /><br /><a class=\"ewLink label\" href=\"logout.php\">" . $Language->Phrase("BackToLogin") . "</a>");
		} else {
