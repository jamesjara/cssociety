...
class clogin extends cowners {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["owners"])) $GLOBALS["owners"] = &$this;
...
<div class="control-group">
  ...
  <div class="control-group">
    <div class="controls">
			<label class="radio"><input type="radio" name="type" id="type" value="a"<?php if ($login->LoginType == "a") { ?> checked="checked"<?php } ?> type="radio"><?php echo $Language->Phrase("AutoLogin") ?></label>
			<label class="radio"><input type="radio" name="type" id="type" value="u"<?php if ($login->LoginType == "u") { ?> checked="checked"<?php } ?> type="radio"><?php echo $Language->Phrase("SaveUserName") ?></label>
			<label class="radio"><input type="radio" name="type" id="type" value=""<?php if ($login->LoginType == "") { ?> checked="checked"<?php } ?> type="radio"><?php echo $Language->Phrase("AlwaysAsk") ?></label>
...
<a class="btn btn-success btn-large" href="register.php"><?php echo $Language->Phrase("Register") ?></a>
    </div>
  </div>
</form>
<script type="text/javascript">
