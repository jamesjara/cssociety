...
class cnoticias_delete extends cnoticias {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate($this->james_url( "noticiaslist.php" )); // Prevent SQL injection, return to list
...
if ($noticias_deleteTotalRecs <= 0) { // No record found, exit
	...
	$noticias_delete->Page_Terminate($this->james_url( "noticiaslist.php" )); // Return to list
}
?>
<h4 id="ewPageCaption" class="page-header ewTitle ewTableTitle"> <?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $noticias->TableCaption() ?></h4>
...
?>
<form name="fnoticiasdelete" id="fnoticiasdelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php } ?>
<br />
<table id="tbl_noticiasdelete" class="ewTable ewTableSeparate table table-striped table-bordered ">
<?php echo $noticias->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<th><span id="elh_noticias_idnoticias" class="noticias_idnoticias">
		<?php echo $noticias->idnoticias->FldCaption() ?></span></th>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $noticias->RowAttributes() ?>>
		<td<?php echo $noticias->idnoticias->CellAttributes() ?>><span id="el<?php echo $noticias_delete->RowCnt ?>_noticias_idnoticias" class="noticias_idnoticias">
